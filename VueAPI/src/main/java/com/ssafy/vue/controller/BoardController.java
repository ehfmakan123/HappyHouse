...
public class BoardController {
	...
	public ResponseEntity<PageDto> listViewBoard(@PathVariable int pageno) throws Exception { 
		return new ResponseEntity<PageDto>(boardService.listViewBoard(pageno), HttpStatus.OK);
	}
