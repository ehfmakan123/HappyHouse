...
public class HouseMapController {
	...
	@GetMapping("/sidoname")
	public ResponseEntity<String> sidoname(@RequestParam("sidoCode") String sidoCode) throws Exception {
		logger.info("sidoname - 호출");
		return new ResponseEntity<String>(houseMapService.getSidoname(sidoCode), HttpStatus.OK);
	}
	
	@GetMapping("/gugunname")
	public ResponseEntity<String> gugunname(@RequestParam("gugunCode") String gugunCode) throws Exception {
		logger.info("gugunname - 호출");
		return new ResponseEntity<String>(houseMapService.getGugunname(gugunCode), HttpStatus.OK);
	}
